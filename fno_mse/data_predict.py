...
if __name__ == "__main__":
    ...
    for i, batch in enumerate(predictions):
        ...
        quality[2*i] = calculate_quality_over_sim(data_truth, geom_file, skip=1, nx=1280, ny=550)
        quality[2*i+1] = calculate_quality_over_sim(data_pred, geom_file, skip=1, nx=1280, ny=550)
    ...
    for m in range(0, 2*len(test_ids),2):
        ...
        perm_df.to_parquet(npy_path / f"Truth_target_quality.parquet")
